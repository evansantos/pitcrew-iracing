    ...
    return {
        ...
        'tires': {
            'lf': {
                ...
                'wearL': safe_get(ir_data, 'LFwearL', 0),
                'wearM': safe_get(ir_data, 'LFwearM', 0),
                'wearR': safe_get(ir_data, 'LFwearR', 0),
                'avgWear': (safe_get(ir_data, 'LFwearL', 0) + safe_get(ir_data, 'LFwearM', 0) + safe_get(ir_data, 'LFwearR', 0)) / 3,
            ...
            'rf': {
                ...
                'wearL': safe_get(ir_data, 'RFwearL', 0),
                'wearM': safe_get(ir_data, 'RFwearM', 0),
                'wearR': safe_get(ir_data, 'RFwearR', 0),
                'avgWear': (safe_get(ir_data, 'RFwearL', 0) + safe_get(ir_data, 'RFwearM', 0) + safe_get(ir_data, 'RFwearR', 0)) / 3,
            ...
            'lr': {
                ...
                'wearL': safe_get(ir_data, 'LRwearL', 0),
                'wearM': safe_get(ir_data, 'LRwearM', 0),
                'wearR': safe_get(ir_data, 'LRwearR', 0),
                'avgWear': (safe_get(ir_data, 'LRwearL', 0) + safe_get(ir_data, 'LRwearM', 0) + safe_get(ir_data, 'LRwearR', 0)) / 3,
            ...
            'rr': {
                ...
                'wearL': safe_get(ir_data, 'RRwearL', 0),
                'wearM': safe_get(ir_data, 'RRwearM', 0),
                'wearR': safe_get(ir_data, 'RRwearR', 0),
                'avgWear': (safe_get(ir_data, 'RRwearL', 0) + safe_get(ir_data, 'RRwearM', 0) + safe_get(ir_data, 'RRwearR', 0)) / 3,
...
def generate_mock_telemetry() -> Dict[str, Any]:
    ...
    return {
        ...
        'tires': {
            'lf': {
                'tempL': round(tire_temp_base + random.uniform(-3, 1), 1),
                'tempM': round(tire_temp_base + random.uniform(-2, 2), 1),
                'tempR': round(tire_temp_base + random.uniform(-1, 3), 1),
                'avgTemp': round(tire_temp_base + random.uniform(-2, 2), 1),
                'wearL': round(0.1 + (lap_num * 0.018), 3),
                'wearM': round(0.1 + (lap_num * 0.020), 3),
                'wearR': round(0.1 + (lap_num * 0.022), 3),
            ...
            'lr': {
                'tempL': round(tire_temp_base - 5 + random.uniform(-3, 1), 1),
                'tempM': round(tire_temp_base - 5 + random.uniform(-2, 2), 1),
                'tempR': round(tire_temp_base - 5 + random.uniform(-1, 3), 1),
                'avgTemp': round(tire_temp_base - 5 + random.uniform(-2, 2), 1),
                'wearL': round(0.1 + (lap_num * 0.013), 3),
                'wearM': round(0.1 + (lap_num * 0.015), 3),
                'wearR': round(0.1 + (lap_num * 0.017), 3),
